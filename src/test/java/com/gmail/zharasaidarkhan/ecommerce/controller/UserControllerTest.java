...
import static com.gmail.zharasaidarkhan.ecommerce.util.TestConstants.*;
...
public class UserControllerTest {
    ...
    public void editUserInfo_ReturnInputErrors() throws Exception {
        mockMvc.perform(post(PathConstants.USER + "/info/edit")
                ...
                .andExpect(status().isOk())
                .andExpect(view().name(Pages.USER_INFO_EDIT))
                .andExpect(model().attribute("firstNameError", Matchers.is(ErrorMessage.EMPTY_FIRST_NAME)))
