...
import com.gmail.zharasaidarkhan.ecommerce.constants.SuccessMessage;
...
import static com.gmail.zharasaidarkhan.ecommerce.util.TestConstants.USER_EMAIL;
import static com.gmail.zharasaidarkhan.ecommerce.util.TestConstants.USER_FIRST_NAME;
...
public class RegistrationControllerTest {
    ...
    public void getRegistrationPage() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.REGISTRATION))
    ...
    public void registration_ReturnInputErrors() throws Exception {
        mockMvc.perform(post(PathConstants.REGISTRATION)
                ...
                .andExpect(status().isOk())
                .andExpect(view().name(Pages.REGISTRATION))
                .andExpect(model().attribute("emailError", Matchers.is(ErrorMessage.EMAIL_CANNOT_BE_EMPTY)))
